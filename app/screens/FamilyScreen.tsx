    ...
    <View style={styles.memberCard}>
      <View style={styles.memberHeader}>
        <View style={styles.avatar}>
          <Image 
            source={member.gender === 'female' ? defaultFemaleAvatar : defaultAvatar}
        ...
        <View style={styles.healthInfo}>
          {member.allergies.length > 0 && (
            <View style={styles.infoSection}>
              ...
              <Text style={styles.infoValue}>{member.allergies.join(', ')}</Text>
            </View>
          )}
          {member.chronicConditions.length > 0 && (
            <View style={styles.infoSection}>
              <Text style={styles.infoLabel}>Chronic Conditions:</Text>
              <Text style={styles.infoValue}>{member.chronicConditions.join(', ')}</Text>
            </View>
          )}
        </View>
      )}
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.form}>
          ...
          <TextInput
            ...
            onChangeText={(value) => setFormData({ ...formData, relation: value })}
          ...
          <TextInput
            ...
            onChangeText={(value) => setFormData({ ...formData, bloodGroup: value })}
          ...
          <TextInput
            ...
            onChangeText={(value) => setFormData({ ...formData, chronicConditions: value })}
